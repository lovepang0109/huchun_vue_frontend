                          ...
                          <div className="area mb-3 py-0">
                            ...
                            <AccordionCollapse eventKey={i.toString()}>
                              <div className="selection-wrap">
                                ...
                                {question?.videos && question?.videos.length ? (
...
export default PublicAttemptSolution;
