            ...
            <div className="container p-0">
                ...
                <div className="row">
                  <div className="col">
                    <div className="section_heading_wrapper mb-md-0">
                      <h3 className="section_top_heading">About You</h3>
                      <p className="section_sub_heading">
                      Tell us about you, your expertise and social presence. Just to let you know that not all of the information will be visible on the public profile.
                      </p>
                    </div>
                  </div>
              ...
              <div className="container6 rounded-boxes bg-white m-0">
                <div className="section_heading_wrapper">
                  ...
                  <p className="section_sub_heading">
                    Labels marked with{" "}
                    <span className="text-danger font-bolder f-16">*</span> are
                    mandatory
                  </p>
                </div>
