                    ...
                    <div className="experiences-box" key={index}>
                      ...
                      {ex.startDate && (
                        <p className="experiences_start_date">
                          {moment(ex.startDate).format('MMM D, YYYY')} -
                          {ex.endDate && !ex.currentlyWorking && (
                            <span>{moment(ex.endDate).format('MMM D, YYYY')}</span>
                          )}
      ...
      >
        ...
        <Modal.Body>
          <form onSubmit={addExperience}>
            ...
            />
            <hr style={{ marginTop: 1, marginBottom: 5 }} />
            <h6 className="form-box_subtitle mb-0">Company</h6>
            <input
              type="text"
              name="search"
            ...
            />
            <hr style={{ marginTop: 1, marginBottom: 5 }} />
            <h6 className="form-box_subtitle mb-0">Location</h6>
            <input
              type="text"
              name="search"
            ...
            <div className="row">
              ...
              {!experience.currentlyWorking && (
                <div className="col-lg-6">
                  <div className="profile-info">
                    <h6 className="form-box_subtitle mb-0">End Date</h6>
            ...
            <h6 className="form-box_subtitle mb-0">Description</h6>
            <input
              type="text"
              name="search"
