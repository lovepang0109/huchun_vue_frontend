...
const StepThree = ({ handleNextInstruction, startTest }: props) => {
  return (
    <>
      <section className="question tutorial-exm_new">
        <div className="question-area">
                  ...
                  <div className="row">
                    <div className="col-lg-8">
                      <div className="left-btn-group clearfix">
                        ...
                        <div className="review-next-btn d-lg-block d-none instruction">
                          <a className="text-white">Mark For Review & Next</a>
                        </div>

                        <div className="save-btn d-lg-block d-none instruction">
                    ...
                    <div className="col-lg-4">
                      <div className="right-btn-group clearfix ml-auto d-lg-block d-none">
                        <div className="previous-btn instruction">
                          <a className="text-white">Previous</a>
                        </div>

                        <div className="save-next-btn instruction">
          ...
          <div className="button-group bg-white d-block d-lg-none instruction fixed-bottom">
            <div className="review-next-btn instruction">
              <a className="text-center">Mark For Review</a>
            </div>

            <div className="save-btn instruction">
              <a className="text-center instruction">Save & Mark For Review</a>
            </div>
      ...
      <div className="instruction-three card-box">
        <div className="card-box-wrap">
          <div className="card-box-inner bg-white">
            <div className="card-box-content">
              <p>
                Use these buttons to navigate and save your answers. Use the
                mark for review button to mark a question for review and proceed
              </p>
            </div>
          </div>
              ...
              <ul className="nav">
                ...
                <li>
                  <a
                    ...
                    onClick={() => handleNextInstruction('four')}
                  >
                    Next
                  </a>
                </li>
