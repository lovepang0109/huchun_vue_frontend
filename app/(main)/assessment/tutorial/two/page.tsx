...
const StepTwo = ({ handleNextInstruction, startTest }: props) => {
  return (
    <>
      <section className="question tutorial-exm2_new">
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="board">
                ...
                <div className="question-box instruction bg-white">
                    ...
                    <ul>
                      <li className="clearfix">
                        <div className="answer clearfix d-flex align-items-center">
                          <span className="pl-3">Option 1</span>
                        </div>
                      </li>

                      <li className="clearfix">
                        <div className="answer clearfix d-flex align-items-center">
                          <span className="pl-3">Option 2</span>
                        </div>
                      </li>

                      <li className="clearfix">
                        <div className="answer clearfix d-flex align-items-center">
                          <span className="pl-3">Option 3</span>
                        </div>
                      </li>

                      <li className="clearfix">
                        <div className="answer clearfix d-flex align-items-center">
                          <span className="pl-3">Option 4</span>
                        </div>
                      </li>
                    </ul>
                  </div>
        ...
        <div className="card-box-wrap">
          <div className="card-box-inner bg-white">
            <div className="card-box-content">
              <p>
                Click on the Checkbox to mark your answers and click on Save and
                Next button to save it
              </p>
            </div>
          </div>
          ...
          <div className="card-box-footer bg-white">
            ...
            <div className="inner ml-auto pl-5">
              <ul className="nav">
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    onClick={() => handleNextInstruction('three')}
                  >
                    Next
                  </a>
                </li>
