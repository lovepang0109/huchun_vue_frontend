...
const StepOne = ({ handleNextInstruction }: { handleNextInstruction: any }) => {
  return (
    <>
        ...
        <div className="modal-dialog instruction">
          <div className="modal-content">
            <div className="modal-body">
              <h2>
                Welcome to Perfectice <span>E-Proctor</span> This tutorial will
                help you learn to use the platform
              </h2>
            </div>

            <div className="modal-footer border-0">
              <div className="run-code-btn m-0">
                <a
                  onClick={() => handleNextInstruction('two')}
