...
import SingUpWithCode from "./SingUpWithCode";
import { AppLogo } from "@/components/AppLogo";
import Svg from "@/components/svg";
import { getSettings } from "@/lib/api";
import Link from "next/link";

export default async function SingUpWithCodePage() {
              ...
              <div className="row no-gutters">
                <div className="col-lg-6 pr-lg-0">
                  <div className="signup-area h-100">
                    <div
                      dangerouslySetInnerHTML={{ __html: settings.signupMsg }}
                    ></div>
                    <Svg.SecureLogin />
                  </div>
                </div>
                <div className="col-lg-6 pr-lg-0">
                  <SingUpWithCode settings={settings}></SingUpWithCode>
                </div>
              </div>
            </div>
          </div>
