        ...
        <v-table>
          <thead>
            <tr>
              ...
              <th class="text-center"></th>
              <th class="text-center"><span>Submited</span></th>
              <th class="text-center"><span>Notified</span></th>
              <th class="text-center"><span>Wrong</span></th>
              <th class="text-center"><span>Forwarded</span></th>
              <th class="text-center"><span>Delivered</span></th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  export default{  
    ...
    computed: {
      ...
      getProviders: function(){
        return this.GetReportCustomers?.providerList?.map( item => `${item.NOMBRE}[${item.ID_PROVEEDOR}]`).splice(0, 50);
      },
      getCustomers: function(){        
        return this.GetReportCustomers?.customerList?.map( item => `${item.NOMBRE} [${item.ID_MASTER}]`).splice(0, 50);
      },
